...
def main():
    PATH_TO_CKPT_FACE = 'model/myssd_mobilenet_v2_face.pb'
    tDetector = TensoflowFaceDector(PATH_TO_CKPT_FACE)

    PATH_TO_CKPT_FACENET_128D = 'model/facenet-20170511-185253.pb'
    PATH_TO_CKPT_FACENET_512D = 'model/facenet-20180408-102900.p'
    myfacenet = FACENET_EMBEDDINGS(PATH_TO_CKPT_FACENET_128D)
